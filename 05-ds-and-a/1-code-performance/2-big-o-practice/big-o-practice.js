...
// Space complexity: O(?)
// O(1)
// since length is a property of arrays, this should be constant time for accessing
...
// Space complexity: O(?)
// O(1)
// nothing is varying by animals.length, since they are being called by index
